...
const dict = {
  UZ: {
    ...
    and: "va",
    expiredTitle: "Taklifnoma hali faollashtirilmagan",
    expiredText: "Sinov vaqti tugadi. Taklifnomani to'ygacha ochiq qilish uchun operatorga yozing va to'lovni amalga oshiring.",
    expiredCta: "Operatorga yozish",
  ...
  RU: {
    ...
    rsvpPhone: "Контактный номер телефона",
    rsvpPhonePlaceholder: "+998 90 123 45 67",
    ...
    and: "и",
    expiredTitle: "Приглашение ещё не активировано",
    expiredText: "Пробное время истекло. Чтобы приглашение работало до свадьбы, напишите оператору и оплатите.",
    expiredCta: "Написать оператору",
